    ...
    <div className="min-h-screen flex w-full">
      <div className="hidden lg:flex w-1/2 bg-gray-900 relative items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 p-12 max-w-xl">
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 hover:bg-white/20 border border-white/10 text-white font-bold text-sm transition-all mb-12 backdrop-blur-md"
          >
          ...
          >
            ...
            <p className="text-lg text-gray-400 font-medium leading-relaxed">
              Log in to access your encrypted notes, sync your latest code
              snippets, and continue your work in complete privacy.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 bg-white dark:bg-gray-950 relative">
        <Link
          href="/"
          className="lg:hidden absolute top-6 left-6 inline-flex items-center gap-2 text-gray-600 dark:text-gray-400 font-bold text-sm hover:text-blue-600 transition-colors"
        >
